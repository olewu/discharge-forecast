...
sN=fread(paste("results/forecast_input/smaakraft/fc_init_",DATE,"T06:00:00Z_merge_sn.csv",sep=""))
...
for(j in 1:length(allcatchments)){
  ...
  # alldates=data.table(date=seq(as_date(paste(startyear,"-01-01")),as_date(DATE+10),by=1))
