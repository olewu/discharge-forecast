...
if [ ! -e /projects/NS9873K/owul/projects/discharge_forecast/data/regular_downloads/sildre_nve/nve/nve_$(date +%Y)-$(date +%m)-$(date +%d).csv ]
then
...
ipython /projects/NS9873K/owul/projects/discharge_forecast/discharge_forecast/update_sildre.py
else
