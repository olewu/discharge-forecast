...
fc10d_nve=/projects/NS9001K/owul/projects/discharge_forecast/data/regular_downloads/metno/nve/metno_$(date +%Y)-$(date +%m)-$(date +%d)T06:00:00Z.csv
fc21d_ppens_nve=/projects/NS9001K/owul/projects/discharge_forecast/results/ens_forecast_input/nve/fc_init_$(date +%Y)-$(date +%m)-$(date +%d).csv
