...
if [ ! -e /projects/NS9873K/owul/projects/discharge_forecast/data/regular_downloads/metno/smaakraft/metno_$(date +%Y)-$(date +%m)-$(date +%d)T06:00:00Z.csv ]
then
...
ipython /projects/NS9873K/owul/projects/discharge_forecast/discharge_forecast/update_forecast.py
