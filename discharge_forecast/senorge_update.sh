...
if [ ! -e /projects/NS9001K/owul/projects/discharge_forecast/data/regular_downloads/senorge/smaakraft/seNorge_$(date +%Y)$(date +%m)$(date +%d).csv ]
then
...
ipython /projects/NS9001K/owul/projects/discharge_forecast/discharge_forecast/update_senorge.py
# create merged files that include latest senorge data and forecast intialized on day of running this script:
ipython /projects/NS9001K/owul/projects/discharge_forecast/discharge_forecast/update_merge_file.py
else
